  ...
  return (
    botTyping && (
      <div className="flex space-x-1">
        ...
        <div
          className={`flex w-fit  space-x-2 self-start whitespace-pre-line break-words rounded-bl-[5px]  rounded-br-[25px] rounded-tl-[20px] rounded-tr-[20px] px-5 py-3 text-sm text-white`}
